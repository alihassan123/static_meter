...
<?php
	...
	function get_data_from_meter( $fd , $packet , $delay = 1 ) 
	{
		...
		echo '<br><br>REQUEST<br>'.$packet . strlen($packet);
		// echo "<br>before_dio_write<br>";
		dio_write( $fd  , $packet);
		// echo "<br>after_dio_write<br>";
		// echo "<br>before_sleep<br>";
		sleep($delay);
		// echo "<br>after_sleep<br>";
		// echo "<br>before_dio_read<br>";
		$r = dio_read( $fd );
		// echo "<br>after_dio_read<br>";
		echo '<br><br>RESPONSE<br>'.$r . ' ' . strlen($r);
		return $r;
	}
